; Modified for AutoKeyboardLayot: 6.7.3 message additions, obsolete keys removed, RTL enabled.
...
ArchiveIncorrectPassword=پاس ورڈ درست نہیں ہے
ArchiveIsCorrupted=آرکائیو خراب ہے
ArchiveUnsupportedFormat=آرکائیو کے اس فارمیٹ کی معاونت نہیں کی جاتی
ButtonStopExtraction=&فائلیں نکالنا روکیں
DownloadingLabel2=فائلیں ڈاؤن لوڈ ہو رہی ہیں...
ErrorDownloading=فائل ڈاؤن لوڈ کرنے کی کوشش کے دوران ایک خرابی پیش آئی:
ErrorExtracting=آرکائیو سے فائلیں نکالنے کی کوشش کے دوران ایک خرابی پیش آئی:
ErrorExtractionAborted=فائلیں نکالنے کا عمل منسوخ کر دیا گیا
ErrorExtractionFailed=فائلیں نکالنے میں ناکامی: %1
ExtractingLabel=فائلیں نکالی جا رہی ہیں...
RetryCancelCancel=منسوخ کریں
RetryCancelRetry=&دوبارہ کوشش کریں
RetryCancelSelectAction=عمل منتخب کریں
SourceVerificationFailed=ماخذ فائل کی تصدیق میں ناکامی: %1
StatusDownloadFiles=فائلیں ڈاؤن لوڈ ہو رہی ہیں...
StopExtraction=کیا آپ واقعی فائلیں نکالنے کا عمل روکنا چاہتے ہیں؟
VerificationFileHashIncorrect=فائل کا ہیش درست نہیں ہے
VerificationFileNameIncorrect=فائل کا نام درست نہیں ہے
VerificationFileSizeIncorrect=فائل کا حجم درست نہیں ہے
VerificationFileTagIncorrect=فائل کا ٹیگ درست نہیں ہے
VerificationKeyNotFound=دستخط کی فائل "%1" میں نامعلوم کلید استعمال ہوئی ہے
VerificationSignatureDoesntExist=دستخط کی فائل "%1" موجود نہیں ہے
VerificationSignatureInvalid=دستخط کی فائل "%1" درست نہیں ہے
